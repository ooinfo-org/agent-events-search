...
async function main() {
  ...
  await ensureFields(listId, [
    ...
    },
    {
      ...
      configJson: { targetListId: LOCAIS_LIST_ID, labelFieldKey: 'nome' },
    },
    {
      key: 'artistas', name: 'Artistas', type: 'RELATION', isRequired: false,
      configJson: { targetListId: ARTISTAS_LIST_ID, labelFieldKey: 'nome_artistico' },
    },
    {
      key: 'organizacoes', name: 'Organizações', type: 'RELATION', isRequired: false,
      configJson: { targetListId: ORGS_LIST_ID, labelFieldKey: 'nome' },
    },
    {
      key: 'fontes', name: 'Fontes', type: 'RELATION', isRequired: true,
      configJson: { targetListId: FONTES_LIST_ID, labelFieldKey: 'nome' },
    },
  ]);
